...
<figure>
  ![Flame graph of a slow
  call](/static/images/20211111-debugging-slow-dynamodb-query/flamegraph-slow.png)
  <figcaption align="center">Flame graph of a slow call</figcaption>
</figure>

<figure>
  ![Flame graph of a fast
  call](/static/images/20211111-debugging-slow-dynamodb-query/flamegraph-fast.png)
  <figcaption align="center">Flame graph of a fast call</figcaption>
</figure>
...
<figure>
  ![Jaegar trace of the first call after
  startup](/static/images/20211111-debugging-slow-dynamodb-query/trace-initial.png)
  <figcaption align="center">Jaegar trace of the first call after startup</figcaption>
</figure>
...
<figure>
  ![Jaegar trace of a slow
  call](/static/images/20211111-debugging-slow-dynamodb-query/trace-slow.png)
  <figcaption align="center">Jaegar trace of a slow call</figcaption>
</figure>

<figure>
  ![Jaegar trace of a fast
  call](/static/images/20211111-debugging-slow-dynamodb-query/trace-fast.png)
  <figcaption align="center">Jaegar trace of a fast call</figcaption>
</figure>
...
<figure>
  ![Wireshark capture of HTTP traffic to
  DynamoDB](/static/images/20211111-debugging-slow-dynamodb-query/wireshark-http.png)
  <figcaption align="center">Wireshark capture of HTTP traffic to DynamoDB</figcaption>
</figure>
...
<figure>
  ![Wireshark capture of a TCP connection with
  DynamoDB](/static/images/20211111-debugging-slow-dynamodb-query/wireshark-tcp15.png)
  <figcaption align="center">Wireshark capture of a TCP connection with DynamoDB</figcaption>
</figure>
